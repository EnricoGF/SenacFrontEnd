...
function changeDirection(event) {
    // verifica qual seta esta sendo pressionada e se a direção atual não é a contraria da seta selecionada
...
function draw() {
    ...
    else if (direction === 'UP') {snakeX -= box}
    else if (direction === 'RIGHT') {snakeX += box}
    else if (direction === 'DOWN') {snakeX += box}
